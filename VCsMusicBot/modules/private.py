...
@Client.on_message(filters.command(["start","start@osmani_vc_bot"]) & ~filters.private & ~filters.channel)
...
@Client.on_message(filters.command(["help","help@osmani_vc_bot"]) & ~filters.private & ~filters.channel)
